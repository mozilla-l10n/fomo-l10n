...
# Move the pt-BR files to pt so Django can find them
# Foundation site
rm -rf ./foundation/translations/locale/pt/
mv ./foundation/translations/locale/pt-BR/ ./foundation/translations/locale/pt/
# Buyers' guide
rm -rf ./foundation/translations/networkapi/buyersguide/locale/pt/
mv ./foundation/translations/networkapi/buyersguide/locale/pt-BR/ ./foundation/translations/networkapi/buyersguide/locale/pt/
rm -rf ./foundation/translations/networkapi/buyersguide/templates/about/locale/pt/
mv ./foundation/translations/networkapi/buyersguide/templates/about/locale/pt-BR/ ./foundation/translations/networkapi/buyersguide/templates/about/locale/pt/
# Mozfest
rm -rf ./foundation/translations/networkapi/mozfest/locale/pt/
mv ./foundation/translations/networkapi/mozfest/locale/pt-BR/ ./foundation/translations/networkapi/mozfest/locale/pt/
